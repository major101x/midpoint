...
const SpecularButton = ({
  ...
  useEffect(() => {
    ...
    const update = (now: number) => {
      ...
      // Local deviation from the vendored file, see design.md section 6.
      // `steer` already implies `pointerAngle != null`, but the narrowing does
      // not survive the intermediate variable under `strict`. Repeating the
      // check is a no-op at runtime and lets `tsc -b` pass.
