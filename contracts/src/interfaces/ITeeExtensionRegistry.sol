...
/// @notice Minimal view of Flare's TEE extension registry.
/// @dev Mirrors the interface shipped in fce-extension-scaffold. Replace with the
/// canonical import once flare-smart-contracts-v2 is published as a package.
